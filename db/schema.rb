...
ActiveRecord::Schema[7.0].define(version: 2022_05_30_202206) do
  ...
  create_table "route_deliveries", force: :cascade do |t|
    t.string "localization"
    t.datetime "date_and_time"
    t.integer "order_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_route_deliveries_on_order_id"
  end
  ...
  add_foreign_key "route_deliveries", "orders"
